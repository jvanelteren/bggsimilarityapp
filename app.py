...
st.sidebar.slider("Minimum average rating",0,10, key='minaverage', step=1, on_change=update) #, format="%.1f")
# st.sidebar.slider("Minimum average rating",0.0,10.0, value=st.session_state['minavgrating2'], key='minaverage', step=0.1, on_change=update) #, format="%.1f")
